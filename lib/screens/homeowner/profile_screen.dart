...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  String _fullName = 'Nigel Delos Reyes';
  String _email = 'nigel@example.com';
  String _phone = '+63 966 876 5709';
  String _address = 'Blk 24 Lot 11 Dasma 1, Dasmarinas, Cavite';
  ...
  Future<void> _fetchHomeownerData() async {
    try {
      ...
      if (user != null) {
        ...
        if (doc.exists && doc.data() != null) {
          final data = doc.data()!;
          setState(() {
            _fullName = data['fullName'] ?? data['name'] ?? 'Nigel Delos Reyes';
            _email = data['email'] ?? user.email ?? '';
            _phone = data['phone'] ?? data['phoneNumber'] ?? '+63 966 876 5709';
            _address = data['address'] ?? data['homeAddress'] ?? 'Blk 24 Lot 11 Dasma 1, Dasmarinas, Cavite';
            _isLoading = false;
          });
          return;
        }
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildActionTile(
                    ...
                    subtitle: 'Tap to view and edit your personal details',
